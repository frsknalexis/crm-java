...
@Repository("detalleCuentaInternetJdbcRepository")
public class DetalleCuentaInternetCustomJdbcRepository implements DetalleCuentaInternetJdbcRepository {
	...
	public String spInsercionCuentaInternet(DetalleCuentaRequest request) {
		...
		try {
			...
			simpleJdbcCall.withProcedureName(Constantes.SP_INSERCION_CUENTA_INTERNET);
